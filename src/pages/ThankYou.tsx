            ...
            {bookingData ? (
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  <h3 className="text-lg font-semibold text-black">Detalles de la Reserva</h3>
                  <span className="text-sm text-gray-600">#{Math.floor(Math.random() * 10000).toString().padStart(4, '0')}</span>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4 py-2">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-black">{bookingData.startTime ? format(bookingData.startTime, "HH:mm") : "No disponible"}</p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-600">Hora de fin:</p>
                    <p className="font-medium text-black">{bookingData.endTime ? format(bookingData.endTime, "HH:mm") : "No disponible"}</p>
                  </div>
                </div>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-black">Equipamiento Adicional</h3>
                  ...
                  <div className="space-y-2">
                    ...
                    {bookingData.addOns.filter(addon => addon.selected).length === 0 && (
                      <p className="text-gray-600 italic">Sin equipamiento adicional</p>
                    )}
                  </div>
                </div>
              </div>
